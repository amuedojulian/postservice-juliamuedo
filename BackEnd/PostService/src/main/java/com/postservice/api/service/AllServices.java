		...
		if (pessoa.getId() != null) {
			...
			if (in != null) {
				if (Strings.isNullOrEmpty(pessoa.getNome())) {
					...
					pessoa.setLocation(in.getLocation());
				} else if (Strings.isNullOrEmpty(pessoa.getEmail())) {
					pessoa.setEmail(in.getEmail());
				}
			}
		}
		pessoaRepository.save(pessoa);
	...
	public void AddDestinatario(Destinatario destinatario) {
		...
		if (destinatario.getId() != null) {
			...
			if (in != null) {
				...
				} else if (Strings.isNullOrEmpty(destinatario.getEmail())) {
					destinatario.setEmail(in.getEmail());
				}
			}
		}
